 ...
 * @param {Float64Array} x_flat_data
 * @param {number} num_rows
 * @param {number} num_cols
 * @returns {RegressionResults}
 */
export function run_multi_linear_regression_wasm(y_values, x_flat_data, num_rows, num_cols) {
    const ptr0 = passArrayF64ToWasm0(y_values, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArrayF64ToWasm0(x_flat_data, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.run_multi_linear_regression_wasm(ptr0, len0, ptr1, len1, num_rows, num_cols);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return RegressionResults.__wrap(ret[0]);
}
...
export class AdfResult {
     ...
     */
    get isStationary() {
        const ret = wasm.__wbg_get_adfresult_isStationary(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @param {boolean} arg0
     */
    set isStationary(arg0) {
        wasm.__wbg_set_adfresult_isStationary(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {object}
     */
    get criticalValues() {
        const ret = wasm.adfresult_criticalValues(this.__wbg_ptr);
        return ret;
    }
}

const RegressionResultsFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_regressionresults_free(ptr >>> 0, 1));
...
export class RegressionResults {
    ...
    static __wrap(ptr) {
        ...
        obj.__wbg_ptr = ptr;
        RegressionResultsFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        RegressionResultsFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_regressionresults_free(ptr, 0);
    }
    /**
     * @returns {Float64Array}
     */
    get coefficients() {
        const ret = wasm.regressionresults_coefficients(this.__wbg_ptr);
     ...
     */
    get stdErrors() {
        const ret = wasm.regressionresults_stdErrors(this.__wbg_ptr);
        var v1 = getArrayF64FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 8, 8);
        return v1;
    }
     ...
     */
    get ssr() {
        const ret = wasm.regressionresults_ssr(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {number}
     */
    get nobs() {
        const ret = wasm.regressionresults_nobs(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    get nparams() {
        const ret = wasm.regressionresults_nparams(this.__wbg_ptr);
        return ret >>> 0;
    }
}
